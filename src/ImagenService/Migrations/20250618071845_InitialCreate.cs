        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RatioCompresion = table.Column<double>(type: "float", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IdImagenOriginal = table.Column<int>(type: "int", nullable: false),
                    IdImagenProcesada = table.Column<int>(type: "int", nullable: false),
                    MSE = table.Column<double>(type: "float", nullable: true),
                    PSNR = table.Column<double>(type: "float", nullable: true),
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "IdAlgoritmoCompresion", "NombreAlgoritmo" },
                values: new object[,]
                {
                    { 1, "JPEG" },
                    { 2, "PNG" },
